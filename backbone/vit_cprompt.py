...
default_cfgs = {
    # patch engine (weights from official Google JAX impl)
    ...
    # patch engine, imagenet21k (weights from official Google JAX impl)
    ...
    # SAM trained engine (https://arxiv.org/abs/2106.01548)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.num_features = self.embed_dim = embed_dim  # num_features for consistency with other engine
        self.num_tokens = 1
        ...
        # Representation layer. Used for original ViT engine w/ in21k pretraining.
...
class ViT_KPrompts(VisionTransformer):
    ...
    def forward(self, x, instance_tokens=None, second_pro=None, returnbeforepool=False,gen_pro=None, **kwargs):
        ...
        if gen_pro is None:
            ...
            if instance_tokens is not None and instance_tokens.shape[0]!=x.shape[0]:
...
def checkpoint_filter_fn(state_dict, model):
    ...
    for k, v in state_dict.items():
        if 'patch_embed.proj.weight' in k and len(v.shape) < 4:
            # For old engine that I trained prior to conv based patchification
...
def _create_vision_transformer(variant, pretrained=False, **kwargs):
    if kwargs.get('features_only', None):
        raise RuntimeError('features_only not implemented for Vision Transformer engine.')

    # NOTE this extra code to support handling of repr size for in21k pretrained engine
    ...
    model = build_model_with_cfg(
        ...
        ViT_KPrompts, variant, pretrained,      # load instance ViT_KPrompts not VisionTransformer
...
@register_model
def vit_tiny_patch16_224_cprompt(pretrained=False, **kwargs):
    """ ViT-Tiny (Vit-Ti/16)
    """
...
@register_model
def vit_tiny_patch16_384_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch32_224_cprompt(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/32)
    """
...
@register_model
def vit_small_patch32_384_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch16_224_cprompt(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/16)
...
@register_model
def vit_small_patch16_384_cprompt(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/16)
    NOTE I've replaced my previous 'small' model definition and weights with the small variant from the DeiT paper
    """
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **kwargs)
...
@register_model
def vit_base_patch32_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base2_patch32_256_cprompt(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/32)
    # FIXME experiment
    """
...
@register_model
def vit_base_patch32_384_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_384_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch8_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch32_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch32_384_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch16_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch16_384_cprompt(pretrained=False, **kwargs):
    """ ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 384x384, source https://github.com/google-research/vision_transformer.
    """
    model_kwargs = dict(patch_size=16, embed_dim=1024, depth=24, num_heads=16, **kwargs)
...
@register_model
def vit_large_patch14_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_huge_patch14_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_giant_patch14_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_gigantic_patch14_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_tiny_patch16_224_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Tiny (Vit-Ti/16).
...
@register_model
def vit_small_patch32_224_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/16)
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_small_patch16_224_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Small (ViT-S/16)
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_base_patch32_224_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Base model (ViT-B/32) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_base_patch16_224_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_base_patch8_224_in21k_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch32_224_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Large model (ViT-L/32) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
...
@register_model
def vit_large_patch16_224_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_huge_patch14_224_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Huge model (ViT-H/14) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has a representation layer but the 21k classifier head is zero'd out in original weights
    """
...
@register_model
def vit_base_patch16_224_sam_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch32_224_sam_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch16_224_dino_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch8_224_dino_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_224_dino_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch8_224_dino_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_224_miil_in21k_cprompt(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
...
@register_model
def vit_base_patch16_224_miil_cprompt(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    Weights taken from: https://github.com/Alibaba-MIIL/ImageNet21K
    """
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, qkv_bias=False, **kwargs)
...
@register_model
def vit_small_patch16_36x1_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch16_18x2_224_cprompt(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_18x2_224_cprompt(pretrained=False, **kwargs):
