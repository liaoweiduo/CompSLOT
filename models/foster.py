...
class Learner(BaseLearner):
    ...
    def _get_loss(self, inputs, targets, stage=1):
        if stage == 1:
            ...
            return loss, {'logits': logits, 'fe_logits': fe_logits, 'old_logits': old_logits, 'loss_clf': loss_clf, 'loss_fe': loss_fe, 'loss_kd': loss_kd}
        
        elif stage == 3:        # compression
            ...
            return loss, {'logits': dark_logits}
    ...
    def _feature_compression(self, train_loader, test_loader):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                loss, res = self._get_loss(inputs, targets, stage=3)
                dark_logits = res['logits']
