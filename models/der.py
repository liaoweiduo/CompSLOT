...
class Learner(BaseLearner):
    ...
    def _get_loss(self, inputs, targets, stage=1, model=None):
        if stage == 1:
            ...
            return loss, {'logits': logits, 'aux_logits': aux_logits, 'loss_clf': loss_clf, 'loss_aux': loss_aux}
