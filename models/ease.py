...
class Learner(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        self.train_dataset = data_manager.get_dataset(np.arange(self._known_classes, self._total_classes), source="train", mode="train", m_rate=m_rate)
    ...
    def _get_loss(self, inputs, targets, model=None): 
        ...
        aux_targets = targets.clone()       # to related targets in the current task
        ...
        return loss, {'logits': logits, 'aux_targets': aux_targets}
    ...
    def update_cfst_fc(self, loader):
        ...
        for _, inputs, targets in loader:
            ...
            with torch.no_grad():
                res = self._network.forward(inputs, test=True)     # res ["logits", "features"]
